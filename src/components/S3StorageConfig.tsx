...
import { ServerIcon, PlusIcon, RefreshCwIcon, EditIcon, TrashIcon } from 'lucide-react';
...
const S3StorageConfig: React.FC = () => {
  ...
  const handleToggleBucketStatus = (bucket: S3Bucket) => {
    ...
    toast.success(`Bucket "${bucket.bucketName}" ${bucket.isActive ? 'deactivated' : 'activated'}`);
  };
  ...
  return (
    <div className="space-y-6">
                ...
                <TableRow key={bucket.id}>
                  ...
                  <TableCell>
                    <div className="flex items-center space-x-2">
                      ...
                      />
                      <span className={bucket.isActive ? 'text-green-600' : 'text-gray-500'}>
              ...
              {buckets.length === 0 && (
                <TableRow>
                  <TableCell colSpan={6} className="text-center py-8">
                    ...
                    <h3 className="mt-4 text-lg font-medium">No buckets configured</h3>
      ...
      {/* Add Bucket Dialog */}
      <Dialog open={isAddBucketDialogOpen} onOpenChange={setIsAddBucketDialogOpen}>
        <DialogContent>
          <DialogHeader>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setIsAddBucketDialogOpen(false)}>
              Cancel
            </Button>
