    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-tr from-blue-50 to-indigo-50 dark:from-blue-950/50 dark:to-indigo-950/50 p-4">
      <div className="w-full max-w-md">
        <div className="mb-8 flex flex-col items-center">
          ...
          <p className="text-sm text-muted-foreground">Gestion de Documents + Assistant IA</p>
        </div>
        
        <AuthForm />
        
        <div className="mt-10 text-center text-sm text-muted-foreground">
          <p className="mb-2">YSM_CegeleC - Gestion de Documents + Assistant IA</p>
          <p>© {new Date().getFullYear()} YSM_CegeleC. Tous droits réservés.</p>
        </div>
      </div>
    </div>
  );
